...
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: 4HarEn2m8J0n/css
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__d6thE)}>
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/narc_shield_io/images/productImgPng.png",
            fullWidth: 100,
            fullHeight: 100,
