...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: JPjHh0Ym_f5I/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__s7Ali)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__d0L1M)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__oObKh)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__xz2XF)}>
          <div className={classNames(projectcss.all, sty.freeBox___7Uqlf)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard__wPzhS)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__nqF1E)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard__uuDOd)}
          />
        </div>
      </Stack__>
    </div>
