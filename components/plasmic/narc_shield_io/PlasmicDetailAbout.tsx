...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: fjwImTvMU27o/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__hbLto)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column___7Cipp)}>
            <h5
